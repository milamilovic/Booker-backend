insert into users (name, surname, email, password, address, phone) values ('Marko', 'Marković', 'email1', '123', 'adresa1', '060000000');
insert into users (name, surname, email, password, address, phone) values ('Petar', 'Petrović', 'email2', '1234', 'adresa2', '060000001');
insert into users (name, surname, email, password, address, phone) values ('Adam', 'Adamović', 'email3', '12345', 'adresa3', '060000002');
