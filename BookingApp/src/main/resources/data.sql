...
VALUES ('Marko', 'Marković', 'email1@gmail.com', '$2a$12$k1vdJAgwlLoYFDid2OlqzOD0KvHmMS936DbLJZjaC3UgITjiM8gBe', 'adresa1', '060000000', 'GUEST', false, false, false, ARRAY[1, 12, 8], 'activation_link1', true, false, null);
...
INSERT INTO users (name, surname, email, password, address, phone, role, reported, blocked, deleted, favourite_accommodations, activation_link, activated, activation_expired, activation_timestamp)
VALUES ('Adam', 'Adamović', 'email3@gmail.com', '$2a$12$aySsOdaOaMgVD9Xmvn5grOQQZ9I9241OMnZ3tCC1nS7QNKYONujma', 'adresa3', '060000002', 'GUEST', false, false, false, ARRAY[5, 6, 7, 8, 9], 'activation_link3', true, false, null);

INSERT INTO users (name, surname, email, password, address, phone, role, reported, blocked, deleted, favourite_accommodations, activation_link, activated, activation_expired, activation_timestamp)
VALUES ('Pera', 'Peric', 'pera123@gmail.com', '$2a$12$KPDq5lv78CgJhvjqDPuLi.puSQKA2yep7pet6LQXsDPdwjg2XtACW', 'Adresa 123', '3210087', 'GUEST', false, false, false, ARRAY[1, 2, 9, 3], 'activation_link4', true, false, null);
